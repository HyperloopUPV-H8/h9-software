...
import { MessageAdapter, PacketUpdate, ConnectionsUpdate, VcuStateAndOrders, BootloaderDownloadRequest, BootloaderDownloadResponse, BootloaderUploadRequest, BootloaderUploadResponse } from "../adapters";
...
export type HandlerMessages = {
    ...
    "blcu/download": Exchange<BootloaderDownloadRequest, BootloaderDownloadResponse>;
    "blcu/response": Subscription<BootloaderDownloadResponse | BootloaderUploadResponse>;
    "vcu/state": Subscription<VcuStateAndOrders>;
};
//# sourceMappingURL=HandlerMessages.d.ts.map